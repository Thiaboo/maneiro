...
class De_Bar_em_BarTests: XCTestCase {
    ...
    func testBarInitializationSucceeds() {
        ...
        let maximumCoordinatesValuesBar = Bar.init(name: "Maximum", address: "AddressPlaceholder", phone: "123456789", photo: nil, rating: 5, coordinate: CLLocationCoordinate2D(latitude: 90 , longitude:180 ))
        XCTAssertNotNil(maximumCoordinatesValuesBar)
        
        // Minimum latitude/longitude values
        let minimumCoordinatesValuesBar = Bar.init(name: "Minimum", address: "AddressPlaceholder", phone: "123456789", photo: nil, rating: 5, coordinate: CLLocationCoordinate2D(latitude: -90 , longitude:-180 ))
    ...
    func testBarInitializationFails() {
        ...
        // Rating exceeds maximum
        let aboveMaximumLatitudeBar = Bar.init(name: "LatitudeTooLarge", address: "AddressPlaceholder", phone: "123456789", photo: nil, rating: 6,  coordinate: CLLocationCoordinate2D(latitude: 0, longitude:0 ))
        XCTAssertNil(aboveMaximumLatitudeBar)
        
        // Rating exceeds maximum
        let belowMinimumLatitudeBar = Bar.init(name: "LatitudeTooSmall", address: "AddressPlaceholder", phone: "123456789", photo: nil, rating: 6,  coordinate: CLLocationCoordinate2D(latitude: 0, longitude:0 ))
        XCTAssertNil(belowMinimumLatitudeBar)
        
        // Rating exceeds maximum
        let aboveMaximumLongitudeBar = Bar.init(name: "LongitudeTooLarge", address: "AddressPlaceholder", phone: "123456789", photo: nil, rating: 6,  coordinate: CLLocationCoordinate2D(latitude: 0, longitude:0 ))
        XCTAssertNil(aboveMaximumLongitudeBar)
        
        // Rating exceeds maximum
        let belowMinimumLongitudeBar = Bar.init(name: "LatitudeTooSmall", address: "AddressPlaceholder", phone: "123456789", photo: nil, rating: 6,  coordinate: CLLocationCoordinate2D(latitude: 0, longitude:0 ))
